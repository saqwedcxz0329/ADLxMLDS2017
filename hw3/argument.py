def add_arguments(parser):
    ...
    parser.add_argument('--trained_pg_model_name', default='model_pg', help='pg pretrained model')
    parser.add_argument('--store_pg_model_name', default='model_pg', help='pg model to store')
    parser.add_argument('--trained_dqn_model_name', default='model_dqn', help='dqn pretrained model')
